ma apko 1 componet detta hoo uspur pagenation ko lajana hai abbi mery pass dummy data hai aur 1 important baat app ny koi style change nhi krna jo chz jha hai wha rehny deni bus pagenation pur kam krna  import React from 'react'
...
<div className='flex w-[70%] gap-4'>
 ...
 </div>   <section className='flex w-full  justify-between'>
...
<div className='flex  item-center  justify-center gap-3 mt-6 text-[12px] mr-10'>
      <p>All</p>
      <p>Campaigns</p>
      <p>Travel logs</p>
      <p>Pins/Post</p>
...
export default All import React, { useEffect, useState } from 'react';
